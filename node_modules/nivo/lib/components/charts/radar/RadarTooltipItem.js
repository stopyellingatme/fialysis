...
var enhance = (0, _compose2.default)((0, _withState2.default)('isHover', 'setIsHover', false), (0, _withPropsOnChange2.default)(['datum', 'keys', 'index', 'colorByKey', 'theme'], function (_ref2) {
    ...
    return {
        tooltip: _react2.default.createElement(_TableTooltip2.default, {
            ...
            rows: (0, _sortBy3.default)(keys.map(function (key) {
                return [_react2.default.createElement(_Chip2.default, { color: colorByKey[key] }), key, datum[key]];
            }), '2').reverse(),
            theme: theme
        })
    };
    ...
    var position = (0, _polar.positionFromAngle)(startAngle + (endAngle - startAngle) * 0.5 - Math.PI / 2, radius);
