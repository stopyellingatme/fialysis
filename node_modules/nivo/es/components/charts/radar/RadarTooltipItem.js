...
var enhance = compose(withState('isHover', 'setIsHover', false), withPropsOnChange(['datum', 'keys', 'index', 'colorByKey', 'theme'], function (_ref2) {
    ...
    return {
        tooltip: React.createElement(TableTooltip, {
            ...
            rows: _sortBy(keys.map(function (key) {
                return [React.createElement(Chip, { color: colorByKey[key] }), key, datum[key]];
            }), '2').reverse(),
            theme: theme
        })
    };
