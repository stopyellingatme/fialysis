...
var enhance = compose(withPropsOnChange(['link', 'theme', 'tooltip'], function (_ref3) {
    var link = _ref3.link,
        theme = _ref3.theme,
    ...
    return {
        tooltip: React.createElement(BasicTooltip, { id: React.createElement(TooltipContent, { link: link }), theme: theme })
    };
